...
#SBATCH --cpus-per-task=5   # number of CPUs for this tasky
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:522814710231:awsnotify --message "RPLSplitJob3Done"
