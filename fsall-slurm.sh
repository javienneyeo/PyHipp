...
python -u -c "import PyHipp as pyh; import DataProcessingTools as DPT; \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:522814710231:awsnotify --message "FSJobDone"
